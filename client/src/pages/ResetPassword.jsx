...
const ResetPassword = () => {
  ...
  return (
    ...
    bg-gradient-to-br from-blue-200 to-purple-400'>
       ...
       sm:left-20 top-5 w-28 sm:w-32cursor-pointer'/>
{/*enter email id*/}
{!isEmailSend && 
       ...
       <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
        ...
        className='bg-transparent outline-none text-white' value={email} onChange={e => setEmail(e.target.value)}
        required/>
       </div>
       ...
       <form onSubmit={onSubmitOTP}className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <div className='flex justify-between mb-8' onPaste={handlePaste}>
          {Array(6).fill(0).map((_, index)=>(
            <input type="text" maxLength='1' key={index} required className='w-12 h-12 bg-[#333A5C] text-white
